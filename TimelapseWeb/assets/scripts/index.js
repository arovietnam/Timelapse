var Index = function () {
    ...
    var getHtml = function(data) {
        ...
        html += '                                           <tr><td class="span2 padding-left-30">Total Snapshots: </td><td class="span2 padding-left-30" id="tdSnapCount' + data.code + '">' + data.snaps_count + '</td><td style="width:25px;padding:0px;text-align:right;" align="right"><img id="imgRef' + data.id + '" style="cursor:pointer;width:25px;height:25px;" data-val="' + data.code + '" class="refreshStats" src="assets/img/refres-tile.png" alt="Refresh Stats" title="Refresh Stats"></td></tr>';
